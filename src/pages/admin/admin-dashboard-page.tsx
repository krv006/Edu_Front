...
export function AdminDashboardPage() {
  ...
  return <main className="portal-page admin-page"><div className="portal-page-heading"><div><span className="portal-eyebrow"><ShieldCheck size={14} /> ADMINISTRATOR</span><h1>Xush kelibsiz, {user?.name}</h1><p>Backendda mavjud bo‘lgan kurs, dars va davomat ma’lumotlari.</p></div><div className="heading-actions"><NotificationBell enabled={Boolean(user)} /><Button variant="secondary" onClick={signOut}><LogOut size={17} /> Chiqish</Button></div></div>
