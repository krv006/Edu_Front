...
export function ParentDashboardPage() {
  ...
  if (dashboard.isLoading || attendance.isLoading) return <LoadingFallback label={t("dashboard.loading")} />;
  if (dashboard.isError || attendance.isError) return <RouteState title={t("dashboard.loadError")} actionLabel={t("dashboard.retry")} onAction={() => { dashboard.refetch(); attendance.refetch(); }} />;
