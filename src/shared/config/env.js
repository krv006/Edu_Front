...
const envSchema = z.object({
  ...
  VITE_API_URL: z
    ...
    .refine(
      ...
      "VITE_API_URL to‘g‘ri URL yoki / bo‘lishi kerak"
    ),
  VITE_WS_URL: z
    .string()
    .trim()
...
if (
  parsedEnv.data.VITE_APP_ENV === "production" &&
  parsedEnv.data.VITE_ENABLE_MOCKS === "true"
) {
  throw new Error(
    "Production muhitida VITE_ENABLE_MOCKS=true bo‘lishi mumkin emas"
  );
}
